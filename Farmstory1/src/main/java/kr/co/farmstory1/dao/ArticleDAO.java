...
public class ArticleDAO {
	...
	public void insertArticel(ArticleBean ab) {
	...
	public void selectArticel() {}
	
	public List<ArticleBean> selectArticels(String cate, int start) {
