...
<%
	...
	// multipart 전송 데이터 수신
	// MultipartRequest mr = new MultipartRequest(request, "파일 저장경로", "파일최대사이즈", "인코딩값", new DefaultFileRenamePolicy());
	...
	if(fname != null){
		...
		String newFname = now+uid+ext; // 20221026111323_bskim617.txt
